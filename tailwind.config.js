  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'mesh-gradient': 'radial-gradient(at 40% 20%, hsla(262,100%,75%,0.15) 0px, transparent 50%), radial-gradient(at 80% 0%, hsla(240,100%,70%,0.1) 0px, transparent 50%), radial-gradient(at 0% 50%, hsla(290,100%,70%,0.1) 0px, transparent 50%)',
      },
      boxShadow: {
